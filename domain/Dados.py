...
class Dados(object):
    ...
    def __init__(self, data_dir, train_percentage = 0.9, valid_percentage = 0.05, test_percentage = 0.05):
        self.data_dir = data_dir
        self.data = (tf.keras.utils.image_dataset_from_directory(data_dir)).map(lambda x, y: (x/255, y))
